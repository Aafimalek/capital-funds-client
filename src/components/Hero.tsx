    ...
    <section className="relative h-screen w-full overflow-hidden bg-navy">
      ...
      <div className="relative z-20 flex h-full flex-col items-center justify-center px-4 text-center sm:px-6 lg:px-8">
        <div className="max-w-5xl space-y-8">
          ...
          {/* Main Headline */}
          <h1 className="animate-fade-in-up text-5xl font-bold tracking-tight text-white sm:text-6xl md:text-7xl lg:text-8xl [text-shadow:0_4px_20px_rgba(0,0,0,0.5)]">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col items-center justify-center gap-4 opacity-0 animate-[fadeInUp_1s_ease-out_0.8s_forwards] sm:flex-row sm:gap-6">
            <a
              href="https://wa.me/918000489090"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-full bg-blue-600 px-8 font-medium text-white transition-all duration-300 hover:bg-blue-700 hover:scale-105 hover:shadow-[0_0_40px_-10px_rgba(59,130,246,0.5)]"
            >
            ...
            <Link
              href="#packages"
              className="group inline-flex h-12 items-center justify-center rounded-full border border-white/10 bg-white/5 px-8 font-medium text-white backdrop-blur-sm transition-all duration-300 hover:bg-white/10 hover:border-white/20"
            >
              View Packages
            </Link>
          </div>
